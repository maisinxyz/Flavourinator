...
4. [Project Timeline & Deliverables](#project-timeline--deliverables)
5. [Firmware Implementation](#firmware-implementation)
...
2x Arduino Uno / Nano (Master and Slave)
I2C LCD Display (16x2 or 20x4)
NEMA 17 Stepper Motors (or 28BYJ-48 with ULN2003 drivers)
Push-button matrix/array
Custom 3D-printed housing and auger assemblies
Software & Deployment
Clone the Repository:
Bash
    git clone [https://github.com/maisinxyz/Automated-Spice-Dispenser-.git](https://github.com/maisinxyz/Automated-Spice-Dispenser-.git)
    ```
2.  **Flash the Master:**
    Navigate to the `Master/` directory, open the sketch in your IDE, and flash to Arduino 1.
3.  **Flash the Slave:**
    Navigate to the `Slave/` directory, open the sketch, and flash to Arduino 2.
4.  **Wiring:**
    Ensure the digital communication pins (defined in `config.h`) between the Master and Slave share a common ground.
